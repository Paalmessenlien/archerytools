...
Generated at: 2025-07-27T18:09:06.383741
"""
...
async def scrape_tophat_products():
            ...
            try:
                ...
                if result.success:
                    try:
                        ...
                        extracted_data['scraped_at'] = "2025-07-27T18:09:06.383746"
    ...
    # Save results
    output_path = Path("/home/paal/arrowtuner2/arrow_scraper/data/retailer_scraping/results_easton_180906_20250727_180906.json")
