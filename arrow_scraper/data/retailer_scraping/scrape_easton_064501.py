...
Generated at: 2025-08-04T06:45:01.607116
"""
...
async def scrape_tophat_products():
            ...
            try:
                ...
                if result.success:
                    try:
                        ...
                        extracted_data['scraped_at'] = "2025-08-04T06:45:01.607121"
    ...
    # Save results
    output_path = Path("/root/archerytools/arrow_scraper/data/retailer_scraping/results_easton_064501_20250804_064501.json")
