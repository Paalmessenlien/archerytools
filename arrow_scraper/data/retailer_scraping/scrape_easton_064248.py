...
Generated at: 2025-08-04T06:42:48.632130
"""
...
async def scrape_tophat_products():
            ...
            try:
                ...
                if result.success:
                    try:
                        ...
                        extracted_data['scraped_at'] = "2025-08-04T06:42:48.632135"
    ...
    # Save results
    output_path = Path("/root/archerytools/arrow_scraper/data/retailer_scraping/results_easton_064248_20250804_064248.json")
