...
const DesignSystemOverview = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemOverview.vue'),
  delay: 200,
  timeout: 3000,
...
const DesignSystemColors = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemColors.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemTypography = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemTypography.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemComponents = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemComponents.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemLayout = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemLayout.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemMobile = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemMobile.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemIcons = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemIcons.vue'),
  delay: 200,
  timeout: 3000
})

const DesignSystemAnimations = defineAsyncComponent({
  loader: () => import('~/components/__archived/design-system/DesignSystemAnimations.vue'),
  delay: 200,
  timeout: 3000
})
