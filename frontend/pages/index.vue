    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <p class="text-blue-800 dark:text-blue-300 mb-4">
          Professional spine calculations and arrow recommendations based on your bow setup.
        </p>
        <NuxtLink to="/calculator">
          <CustomButton variant="filled" class="bg-blue-600 text-white hover:bg-blue-700">
            <i class="fas fa-calculator mr-2"></i>
            Open Calculator
          </CustomButton>
        </NuxtLink>
      ...
      <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-lg border border-green-200 dark:border-green-800">
        ...
        <p class="text-green-800 dark:text-green-300 mb-4">
          Browse 1,100+ arrow specifications from 13 leading manufacturers worldwide.
        </p>
        <NuxtLink to="/database">
          <CustomButton variant="filled" class="bg-green-600 text-white hover:bg-green-700">
...
// Selected bow setup from my-page navigation
...
// Load data on mount
onMounted(() => {
  // Check if a bow setup was selected from the my-page
  if (process.client) {
